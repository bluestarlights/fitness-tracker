# BodyProfile Tracker V5.1 Cutting
...
## V5.1 기본값
최초 사용 시 아래 시작값이 자동 표시됩니다. 오늘 기록이나 지난 세션 기록이 있으면 해당 값이 우선됩니다.

- 벤치프레스 60kg, 스쿼트 70kg, RDL 60kg
- 인클라인 덤벨 16kg(각), 숄더프레스 14kg(각)
- 레그프레스 140kg, 런지 10kg(각)
- 플랭크 60초
- 나머지 운동도 종목별 권장 시작값 적용

한 번 실제 중량으로 수정하면 다음 세션부터 수정한 지난 기록이 자동 프리필됩니다.
